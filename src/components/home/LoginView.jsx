    ...
    return (
        <section className="booking-section">
            <div className="booking-card" style={{ maxWidth: '400px', margin: '0 auto' }}>
                <h1 className="identity-title">로그인</h1>
                <p style={{ textAlign: 'center', color: 'var(--text-secondary)', marginBottom: '1.5rem', fontSize: '0.9rem', lineHeight: '1.6', wordBreak: 'keep-all' }}>
                    예매를 계속하거나 내역을 확인할 때<br />사용하는 번호를 입력해주세요.
                </p>
